...
class MyApp(frenetic.App):
    ...
    def connected(self):
        ...
        #        pol = Filter(SwitchEq(51570677359425) & IP4DstEq("10.0.0.5")) >> SetPort(5)
        pol = Filter(SwitchEq(51570677359425) & IP4SrcEq("10.0.0.7") & IP4DstEq("10.0.0.5")) >> SendToController(
            "attacker")
        ...
        pol = pol | Filter(SwitchEq(51570677359425) & IP4DstNotEq("10.0.0.5") & IP4DstNotEq("10.0.0.7") & IP4DstNotEq(
            "10.0.0.6") & IP4DstNotEq("10.0.0.8") & IP4DstNotEq("10.0.0.4") & IP4DstNotEq("10.0.0.9")) >> SetPort(4)
        ...
        pol = pol | Filter(SwitchEq(99947915534402) & IP4DstNotEq("10.0.0.2") & IP4DstNotEq("10.0.0.1") & IP4DstNotEq(
            "10.0.0.3")) >> SetPort(3)
