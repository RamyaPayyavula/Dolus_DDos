...
def calculateTargetedSSByTime(trace_id, device_id):
    ...
    SSSID = session.query(SuspiciousnessScoresByTime).count()
    try:
        while minFrame < maxFrame:
            ...
            query += "and l.ip_dst <> ' ' and trace_id = " + str(trace_id) + " and frame_time >= " + str(minFrame) + " and frame_time < " + str(minFrame) + " + 10 ) a	) g;"
