...
TRAIN_DATA = ['learningdata/root-switch-test1-part1.csv', 'learningdata/root-switch-test1-part2.csv', 'learningdata/slave-switch-test1-part1.csv', 'learningdata/slave-switch-test1-part2.csv']
TEST_DATA = ['learningdata/root-switch-test2-part1.csv', 'learningdata/root-switch-test2-part2.csv', 'learningdata/slave-switch-test2-part1.csv', 'learningdata/slave-switch-test2-part2.csv']
